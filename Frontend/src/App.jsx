          ...
          <div className="flex px-3">
            <div className="w-[60px] ">
              <a href="#projects" className="flex text-white font-semibold  ">
                <img
                  src="./src/resources/icons/project-management.png"
                  alt=""
      ...
      >
        ...
        <div className="flex flex-col items-center  ">
          <div className="text-white py-10">
            {/* name */}
            <p className="text-[15px]  sm:text-lg font-semibold mb-[-5px] sm:mb-[-12px] pl-1">
              Hii I'am ,
            </p>
            <motion.div
              className="flex text "
            ...
            >
              <span className="text-4xl sm:text-[65px] hover:scale-80 font-bold text-gray-400 hover:text-red-500 hover:rotate-15 transition  duration-199">
                R
              </span>
              <span className="text-4xl sm:text-[65px] hover:scale-80 font-bold text-gray-400 hover:text-red-500 hover:rotate-15 transition duration-199">
                i
              ...
              <span className="text-4xl sm:text-[65px] hover:scale-80 font-bold text-gray-400 hover:text-red-500 hover:rotate-15 transition duration-199 ml-2">
                V
              </span>
              <span className="text-4xl sm:text-[65px] hover:scale-80 font-bold text-gray-400 hover:text-red-500 hover:rotate-15 transition duration-199">
                e
            ...
            <motion.h1
              ...
              className="text-lg font-semibold pl-2 text-center mt-3"
            >
              I am{" "}
        ...
        {/* {seperation line} */}
        <div className="text-white mt-[100px] flex pt-5 text-2xl font-bold w-[100%] sm:text-3xl border-t  border-gray-800 justify-center items-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-5 sm:gap-[100px] mt-10" id='projects'>
          {/* {first project} */}
